...
CHOSEN_BRANCHES = [
    ...
    ChosenBranch("Tilt-servo power branches", "16", 1.20, 2, quantity=2, allowance_percent=15, notes="One branch per front motor tilt servo"),
    ChosenBranch("8.4 V regulator input pair", "16", 0.30, 2, allowance_percent=10, notes="12S protected bus to control-servo regulator"),
    ChosenBranch("8.4 V control-servo trunk pair", "14", 0.40, 2, allowance_percent=10, notes="Regulator to control-servo distribution"),
    ChosenBranch("Control-servo branch - left wing", "16", 1.10, 2, allowance_percent=15, notes="8.4 V servo power"),
    ChosenBranch("Control-servo branch - right wing", "16", 1.10, 2, allowance_percent=15, notes="8.4 V servo power"),
    ChosenBranch("Control-servo branch - left tailplane", "16", 1.60, 2, allowance_percent=15, notes="8.4 V servo power"),
    ChosenBranch("Control-servo branch - right tailplane", "16", 1.60, 2, allowance_percent=15, notes="8.4 V servo power"),
    ChosenBranch("Control-servo branch - rudder", "16", 1.70, 2, allowance_percent=15, notes="8.4 V servo power"),
    ChosenBranch("ESC signal and ground pairs", "24", 1.37, 2, quantity=3, allowance_percent=15, notes="Average ESC signal route"),
    ChosenBranch("Servo signal and ground pairs", "24", 1.36, 2, quantity=7, allowance_percent=15, notes="Average servo signal route"),
